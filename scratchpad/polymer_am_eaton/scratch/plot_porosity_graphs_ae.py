...
samp1 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="1"])
samp2 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="2"])
samp3 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="3"])
samp4 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="4"])
samp5 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="5"])
samp6 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="6"])
samp7 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="7"])
samp8 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="8"])
samp9 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="9"])
samp10 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="10"])
samp11 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="11"])
samp12 = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="12"])
sampleinj = np.mean([porosity[i] for i in sample_tag if sample_tag[i]=="injmold"])
